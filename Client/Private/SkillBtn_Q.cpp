...
CSkillBtn_Q::CSkillBtn_Q(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CUI{ pDevice, pContext }
{
}

CSkillBtn_Q::CSkillBtn_Q(const CSkillBtn_Q& rhs)
	: CUI{ rhs },
...
HRESULT CSkillBtn_Q::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CSkillBtn_Q::Initialize(void* pArg)
{
	...
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(-m_fX + g_iWinSizeX - 100.f, m_fY - g_iWinSizeY + m_fSizeY * 0.5f + 30.f, 0.f, 1.f));
...
void CSkillBtn_Q::Priority_Tick(const _float& fTimeDelta)
{
}

void CSkillBtn_Q::Tick(const _float& fTimeDelta)
{
}

void CSkillBtn_Q::Late_Tick(const _float& fTimeDelta)
{
...
HRESULT CSkillBtn_Q::Add_Components()
{
	...
	if (FAILED(__super::Add_Component(CMainApp::g_iCurrentLevel, L"Prototype_Component_Texture_UI_Btn_Frame_38", L"Com_Texture", reinterpret_cast<CComponent**>(&m_pTextureCom))))
		return E_FAIL;

	return S_OK;
}

HRESULT CSkillBtn_Q::Bind_ResourceData()
{
...
HRESULT CSkillBtn_Q::Ready_Icon()
{
	...
	Desc.strComponentPrototypeTag = L"Prototype_Component_Texture_UI_SkillBtn_Icon_Q_Tighnari";
	Desc.fSizeX = 100.f;
	Desc.fSizeY = 100.f;
	...
	Desc.strComponentPrototypeTag = L"Prototype_Component_Texture_UI_SkillBtn_Icon_Q_Nilou";
	...
	Desc.strComponentPrototypeTag = L"Prototype_Component_Texture_UI_SkillBtn_Icon_Q_Wanderer";
	...
	Desc.strComponentPrototypeTag = L"Prototype_Component_Texture_UI_SkillBtn_Icon_Q_Feiyan";
...
CSkillBtn_Q* CSkillBtn_Q::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CSkillBtn_Q* pInstance = new CSkillBtn_Q(pDevice, pContext);
...
CGameObject* CSkillBtn_Q::Clone(void* pArg)
{
	CSkillBtn_Q* pInstance = new CSkillBtn_Q(*this);
