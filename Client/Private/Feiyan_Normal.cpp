...
HRESULT CFeiyan_Normal::Initialize(void* pArg)
{
	...
	m_pParentMatrix = pDesc->ParentMatrix;
...
HRESULT CFeiyan_Normal::Add_Components()
{
	...
	if (FAILED(__super::Add_Component(CMainApp::g_iCurrentLevel, L"Prototype_Component_Texture_Skill_Feiyan_Normal_Fire", L"Com_Texture", reinterpret_cast<CComponent**>(&m_pTextureCom))))
		return E_FAIL;
	...
	StartParticleDesc.pPlayerMatrix = m_pParentMatrix;
	StartParticleDesc.fDuration = 0.4f;

	if (FAILED(m_pGameInstance->Add_GameObject(CMainApp::g_iCurrentLevel, TEXT("Prototype_GameObject_Effect_Feiyan_Normal_Start_Particle"), TEXT("Layer_Particle"), &StartParticleDesc)))
		return E_FAIL;
	...
	if (FAILED(m_pGameInstance->Add_GameObject(CMainApp::g_iCurrentLevel, TEXT("Prototype_GameObject_Effect_Feiyan_Normal_Start_Texture"), TEXT("Layer_Particle"), &TextureDesc)))
		return E_FAIL;
