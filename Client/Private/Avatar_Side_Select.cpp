...
HRESULT CAvatar_Side_Select::Add_Components()
{
	...
	if (FAILED(__super::Add_Component(LEVEL_GAMEPLAY, L"Prototype_Component_Texture_UI_Avatar_Side_Select_Frame", L"Com_Texture", reinterpret_cast<CComponent**>(&m_pTextureCom))))
		return E_FAIL;
