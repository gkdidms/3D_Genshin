...
namespace Client {
    enum ELEMENTAL_TYPE { WATER, FIRE, ELECTRIC, DENDRO, ANEMO, ELEMENTAL_END };
	enum LEVEL_STATE { LEVEL_STATIC, LEVEL_LOADING, LEVEL_LOGO, LEVEL_GAMEPLAY, LEVEL_STAGE_BOSS, LEVEL_END};
    ...
    enum PLAYER_STATE {
        ...
        PALYER_ATTACK_SPEC,
        PLAYER_ATTACK_END,
        PLAYER_EXTRA_ATTACK_START,
        PLAYER_EXTRA_ATTACK,
        PLAYER_EXTRA_ATTACK_END,
