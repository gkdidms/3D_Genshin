...
public:
    ...
    enum PLAYER_STATE { PLAYER_IDLE, PLAYER_RUN_START, PLAYER_RUN, PLAYER_STOP, PLAYER_SPRINT, PLAYER_JUMP, PLAYER_FLY, PLAYER_ATTACK_1, PLAYER_ATTACK_2, PLAYER_ATTACK_3, PLAYER_ATTACK_4, PLAYER_ELEMENTAL_1, PLAYER_ELENENTAL_BURST, PLAYER_END};
